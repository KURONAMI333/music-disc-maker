 ...
 * {@link #install} で差し込み、他 MOD の型はそこに閉じ込める ({@code ExternalPlaybackMirror} と
 ...
 */
public final class AdditionalAdditionsAlbumSupport {
    ...
    private AdditionalAdditionsAlbumSupport() {
    }
