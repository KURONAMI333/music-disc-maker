 ...
 *
 * <p>方式は <b>IP ベース遮断</b> (ドメイン allowlist ではない): 将来のラジオ機能で任意の公開
 ...
 *       すり抜ける。接続層でのリダイレクト先再検査が必要で T1 の範囲外。</li>
 * </ul>
...
public final class UrlGuard {
    ...
    /** 検査結果。拒否理由を区別できるようにして上位のメッセージ分岐 (Track 3) に渡せる形にする。 */
    public enum Reason {
        /** 通過。 */
        OK,
        /** URL が空・null・解析不能。 */
