...
public final class ModMenus {
    ...
    public static final RegistryHolder<MenuType<DiscDyeingTableMenu>> DISC_DYEING_TABLE =
            MENUS.register("disc_dyeing_table", () -> Services.MENU.createDiscDyeingTableMenuType());
    ...
    public static final RegistryHolder<MenuType<AlbumMenu>> ALBUM =
            MENUS.register("album", () -> Services.MENU.createAlbumMenuType());
