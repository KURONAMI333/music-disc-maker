 ...
 * に custom disc のストリーミング再生を開始/停止する単一の入口。
 *
 * <p>v1.1.0 から custom disc は JUKEBOX_PLAYABLE component を持つので、挿入/排出はバニラの
 * {@link net.minecraft.world.level.block.entity.JukeboxBlockEntity#setTheItem} が処理する。
 * その setTheItem を mixin で TAIL フックし、このメソッドへ流すことで、あらゆる経路の再生を1点に集約する。
 */
