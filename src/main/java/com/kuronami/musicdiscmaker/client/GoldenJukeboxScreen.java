...
public class GoldenJukeboxScreen extends AbstractContainerScreen<GoldenJukeboxMenu> {
    ...
    private void sendConfig() {
        ClientPacketDistributor.sendToServer(new ConfigureJukeboxPayload(
    ...
    protected void extractLabels(GuiGraphicsExtractor g, int mouseX, int mouseY) {
        ...
        if (track != null) {
            ...
            g.text(font, font.plainSubstrByWidth(title, TRACK_TEXT_W),
            ...
            if (desc != null) {
                g.text(font, font.plainSubstrByWidth(desc.getString(), TRACK_TEXT_W),
                        TRACK_TEXT_X, TITLE_Y, TEXT, false);
    ...
    private final class SeekBar extends AbstractWidget {
        ...
        public boolean mouseReleased(MouseButtonEvent event) {
            if (scrubbing && event.button() == 0) {
                ...
                ClientPacketDistributor.sendToServer(new SeekJukeboxPayload(be.getBlockPos(), offset));
