// 26.2 ノード。ModDevGradle 2.0.142 / NeoForge 26.2.0.28-beta / Java 25。
plugins {
    id("java-library")
...
val mcVersion = "26.2"
val mcVersionRange = "[26.2,)"
val neoforgeVersion = "26.2.0.28-beta"
val neoforgeLoaderRange = "[1,)"
val javaVersion = 25
val compatLibsDir = rootProject.file("neoforge/compat-libs-26.2")
