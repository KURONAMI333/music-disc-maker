// 26.1.2 ノード。ModDevGradle 2.0.142 / NeoForge 26.1.2.36-beta / Java 25。
// プラグイン版はツリー側 (2.0.142) に合わせる (mod-049 の実記述は 2.0.141)。
plugins {
    id("java-library")
...
val mcVersionRange = "[26.1.2,]"
val neoforgeVersion = "26.1.2.36-beta"
val neoforgeLoaderRange = "[1,)"
val javaVersion = 25
val compatLibsDir = rootProject.file("neoforge/compat-libs-26.1.2")
