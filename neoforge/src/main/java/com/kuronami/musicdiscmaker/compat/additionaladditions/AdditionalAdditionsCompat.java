 ...
 * {@link ExternalPlaybackMirror} 経由で server→client のストリーム packet を出して実音声を鳴らす。
 */
public final class AdditionalAdditionsCompat {
     ...
     * そうでなければ null を、保持 stack と一緒に {@link ExternalPlaybackMirror#mirrorAlbumJukebox} に渡す。
     *
