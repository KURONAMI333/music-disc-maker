...
public final class SableCompat {
    ...
    public static void registerPayload(PayloadRegistrar registrar) {
        registrar.playToClient(SubLevelStopDiscPayload.TYPE, SubLevelStopDiscPayload.STREAM_CODEC,
                (payload, context) -> context.enqueueWork(() -> SableAudioClient.stop(payload)));
