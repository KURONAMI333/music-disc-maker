// 26.2 ノード。fabric-loom は id が net.fabricmc.fabric-loom の 1.16.3 / Java 25。
plugins {
    id("java-library")
...
val javaVersion = 25
val compatLibsDir = rootProject.file("fabric/compat-libs-26.2")
...
dependencies {
    ...
    // MC 26.x は難読化解除済み。mappings 宣言は不要 (mod-050 と同じ)。
...
tasks.named<ProcessResources>("processResources") {
    ...
    val expandProps = mapOf(
        ...
        "minecraft_version_range" to "[26.2,)",
