...
/**
 * client 側: backpack(storageUuid) 位置で MDM の custom disc を LavaPlayer 再生する (Fabric 1.20.1)。
 * 通常の jukebox 再生 ({@code ClientPlaybackManager}) と違い、SC の {@link StorageSoundHandler} に
 * storageUuid で登録するので、SC が送る停止 (stopStorageSound) でこの DiscSoundInstance も自動的に止まる。
 *
