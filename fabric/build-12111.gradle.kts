// 1.21.11 ノード。fabric-loom は id が fabric-loom (別座標) の 1.14.10 / Java 21。
plugins {
    id("java-library")
...
val javaVersion = 21
val compatLibsDir = rootProject.file("fabric/compat-libs-1.21.11")
...
dependencies {
    ...
    // MC 1.21.11 は難読化ありなので mappings + remap 経路 (mod-051 と同じ)。
