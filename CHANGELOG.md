...
- The "Login wall" (bot check) message no longer names YouTube specifically — it now also covers a direct audio link getting rejected with a 401/403/429, and points you at a direct link or another source instead of leaving you stuck.
