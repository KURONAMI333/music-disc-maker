...
- **Fixed a disc sometimes staying silent with no reason shown on screen.** Taking it back out and putting it in again usually made it play, but the first attempt could give up without saying why. This is now reported and handled the same way as any other playback failure.
